...
document.getElementById("gen_info").getElementsByTagName("tr")[0].childNodes[3].textContent="hello I'm Bjork";
...
createTableFromData("bottom_attendance", senateWORSTattendance());
...
createTableFromData("top_attendance", senateBESTattendance());
